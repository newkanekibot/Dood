...
async def start_message(bot, message):
    await message.reply_text(
        text="Hᴇʟʟᴏ 👋,\n\nTʜɪs Is A Dᴏᴏᴅ Sᴛʀᴇᴀᴍ Uᴘʟᴏᴀᴅᴇʀ Bᴏᴛ\n\nYᴏᴜ Cᴀɴ Uᴘʟᴏᴀᴅ Vɪᴅᴇᴏ Fʀᴏᴍ Dɪʀᴇᴄᴛ/Rᴀᴡ Uʀʟ Tᴏ Dᴏᴏᴅ Dᴛʀᴇᴀᴍ\n\nCʟɪᴄᴋ Oɴ /help Fᴏʀ Mᴏʀᴇ Dᴇᴛᴀɪʟs\n\nPᴏᴡᴇʀᴅ Bʏ : @Cyberhunt27",
        reply_markup=InlineKeyboardMarkup( [[
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ", url="https://t.me/SkyBotId"),
            InlineKeyboardButton("Gʀᴏᴜᴘ", url="https://t.me/Skybotsupport")
            ],[
            InlineKeyboardButton("Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="https://github.com/erickskynet")
            ]]
            )
       )
